...
<form method="POST" action="tratamiento.php?action=update&id=<?php echo $id; ?>">
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="tratamiento" name="tratamiento" value="<?php echo $data['tratamiento']; ?>" placeholder="Escribe el nombre del tratamiento" required>
    </div>    
    <div class="mb-3">
